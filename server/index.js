...
const createRoom = (date, bid, maxUsers) => {
  return {
    id: v4(),
    date,
    bid,
...
const resolvers = {
  ...
  Mutation: {
    ...
    createRoom: (prev, { date, bid, maxUsers }) => {
      const room = createRoom(date, bid, maxUsers)
      rooms.push(room)
      return room
    },
  },
